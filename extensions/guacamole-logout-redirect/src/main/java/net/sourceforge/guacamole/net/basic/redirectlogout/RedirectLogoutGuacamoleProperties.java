 ...
 */
public class RedirectLogoutGuacamoleProperties {

    /**
     * This class should not be instantiated.
     */
    private RedirectLogoutGuacamoleProperties() {}

    /**
     * The url to redirect to for Logout
     */
    public static final StringGuacamoleProperty REDIRECT_URL = new StringGuacamoleProperty() {

        @Override
        public String getName() { return "redirect-url"; }
